...
<div class="d-flex flex-column gap-4" style="max-width: 800px;">
    ...
    @if(session('success'))
    <div class="alert alert-success border-0 shadow-sm d-flex align-items-center gap-2 mb-0" role="alert" style="background-color: #d1fae5; color: #047857;">
    ...
    <form action="{{ route('admin.settings.update') }}" method="POST">
        ...
        <div class="d-flex flex-column gap-4">
                    ...
                    <div class="d-flex flex-column gap-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" name="email_notifications" id="emailNotifications" checked style="width: 40px; height: 20px;">
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" name="late_payment_alerts" id="latePaymentAlerts" checked style="width: 40px; height: 20px;">
                            </div>
                        </div>

                        <!-- Reminder Days -->
                        <div>
                             <label for="reminderDays" class="form-label fw-medium text-dark">Reminder Days Before Due Date</label>
                             <input type="number" class="form-control" id="reminderDays" name="reminder_days" value="7">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" name="auto_approval" id="autoApproval" style="width: 40px; height: 20px;">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    ...
                    <div>
                         ...
                         <input type="email" class="form-control" id="adminEmail" name="admin_email" value="admin@donation.com">
            ...
            <div class="d-flex justify-content-end mt-2">
                <button type="submit" class="btn btn-primary d-flex align-items-center gap-2 px-4 py-2 shadow-sm fw-medium">
