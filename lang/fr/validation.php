...
return [
    ...
    */
    ...
    'encoding' => 'Le champ :attribute doit être encodé au format :encoding.',
    ...
    'password' => [
        ...
        'uncompromised' => 'La valeur donnée pour le champ :attribute est apparue dans une fuite de données. Veuillez choisir une autre valeur pour :attribute.',
    ],
